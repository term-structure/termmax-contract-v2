...
contract SwapAdapter is ERC20SwapAdapter {
    ...
    function _swap(
        ...
        (address tokenInPriceFeedAddr, address tokenOutPriceFeedAddr) = abi
            .decode(swapData, (address, address));
        ...
        MockPriceFeed tokenOutPriceFeed = MockPriceFeed(
            address(tokenOutPriceFeedAddr)
        );
        ...
        tokenOutAmt =
            (amount *
                ...
                10 ** tokenOutPriceDecimals *
                10 ** tokenOutDecimals) /
            (uint256(tokenOutPrice) *
                10 ** tokenInPriceDecimals *
                10 ** tokenInDecimals);
