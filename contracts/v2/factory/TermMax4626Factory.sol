...
contract TermMax4626Factory {
    ...
    event TermMax4626FactoryInitialized(address aavePool, uint16 aaveReferralCode, address stableERC4626For4626Implementation, address stableERC4626ForAaveImplementation, address variableERC4626ForAaveImplementation);
    ...
    constructor(address aavePool, uint16 aaveReferralCode) {
        ...
        emit TermMax4626FactoryInitialized(aavePool, aaveReferralCode, stableERC4626For4626Implementation, stableERC4626ForAaveImplementation, variableERC4626ForAaveImplementation);
    }

    function createStableERC4626For4626(address admin, address thirdPool, StakingBuffer.BufferConfig memory bufferConfig) external returns (StableERC4626For4626) {
    ...
    function createStableERC4626ForAave(address admin, address underlying, StakingBuffer.BufferConfig memory bufferConfig) public returns (StableERC4626ForAave) {
    ...
    function createVariableERC4626ForAave(address admin, address underlying, StakingBuffer.BufferConfig memory bufferConfig) public returns (VariableERC4626ForAave) {
    ...
    function createVariableAndStableERC4626ForAave(address admin, address underlying, StakingBuffer.BufferConfig memory bufferConfig) external returns (VariableERC4626ForAave, StableERC4626ForAave) {
