...
contract TermMaxViewer is UUPSUpgradeable, Ownable2StepUpgradeable {
        ...
        returns (uint256 maxRedeem, uint256 totalBadDebt, uint256 totalCollateral)
    {
        ...
        // User can pay at most totalBadDebt to get all collateral
        // If user has less than totalBadDebt, they get proportional collateral
        maxRedeem = totalCollateral.mulDiv(userAssets.min(totalBadDebt), totalBadDebt);
    }
