...
interface ITermMaxRouterV2_1 {
     ...
     * @param paths Array of swap paths to use for the swap
     * @return netTokenOut Actual amount of output tokens received
     */
    function swapExactTokenToToken(SwapPath[] calldata paths) external returns (uint256 netTokenOut);
     ...
     */
    function swapTokenToExactToken(SwapPath[] calldata paths) external returns (uint256 netTokenIn);
