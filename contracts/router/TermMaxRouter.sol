  ...
  PausableUpgradeable, IFlashLoanReceiver, ITermMaxRouter
{
  ...
  function withdrawLiquidityToToken(
    ...
    if (_redeemFtAndXtToUnderlying(market, receiver, underlying, ftOutAmt, xtOutAmt) < minTokenOut) {
      revert("Slippage: INSUFFICIENT_TOKEN_OUT");
    }
    // TODO: return underlying token amount, 
  }
  ...
  function redeem(
    ...
    uint256 netOut = _balanceOf(underlying, address(this));
