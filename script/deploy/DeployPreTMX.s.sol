...
contract DeployPreTMX is DeployBaseV2 {
    ...
    address preTmxAdmin = 0x65B7949C97e7d96bCd81cf53BfF602923973c950;
    bool isBroadcast;
    ...
    function run() public {
        ...
        PreTMX preTmx = new PreTMX(preTmxAdmin);
        address deployedAddress = address(preTmx);
        console.log("Deployed PreTMX at:", deployedAddress);
        require(preTmx.owner() == preTmxAdmin, "PreTMX owner mismatch");
        require(preTmx.balanceOf(preTmxAdmin) == 1e9 ether, "PreTMX initial supply mismatch");
        vm.stopBroadcast();
