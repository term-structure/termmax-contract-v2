...
contract DeployAccessManager is DeployBase {
    ...
    function setUp() public {
        ...
        pendleSwapV3Router = vm.envAddress(pendleSwapV3RouterVar);
    }
    ...
    function run() public {
        ...
        console.log("PendleSwapV3Router:", pendleSwapV3Router);

        uint256 currentBlock = block.number;
        uint256 currentTimestamp = block.timestamp;

        vm.startBroadcast(deployerPrivateKey);
        PendleSwapV3Adapter pendleSwapV3Adapter = new PendleSwapV3Adapter(address(pendleSwapV3Router));
        ...
        console.log("===== PendleSwapV3Adapter Info =====");
        ...
        // Write the JSON file
        string memory filePath = string.concat(deploymentsDir, "/", network, "-pendle-swap-v3-adapter.json");
