...
contract DeloyMarketEthSepolia is DeployBase {
    ...
    // address config
    address faucetAddr = address(0x427F56E0E8CfA7c61dC4a4DB1215541533bf41d2);
    address factoryAddr = address(0x379303EF42b65a43e41a9FF220D081A786664795);
    address routerAddr = address(0x7c1D51DA140A019736b421Eec663df904a4Beebe);
