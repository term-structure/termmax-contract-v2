        ...
        for (uint256 i; i < oracleConfigs.length; i++) {
            ...
            if (config.needsDeployment) {
                if (config.deployFeedParams.priceFeedType == JsonLoader.PriceFeedType.PriceFeedWithERC4626) {
                    console.log("  Underlying price feed:", config.deployFeedParams.underlyingPriceFeed);
                    ...
                    console.log("  Price feed A->B:", config.deployFeedParams.priceFeed1);
                    console.log("  Price feed B->C:", config.deployFeedParams.priceFeed2);
                    // config.oracleParams.aggregator = AggregatorV3Interface(
                    ...
                    console.log("  Pendle PY LP Oracle:", config.deployFeedParams.pendlePYLpOracle);
                    console.log("  Pendle Market:", config.deployFeedParams.market);
                    console.log("  Underlying asset price feed:", config.deployFeedParams.underlyingPriceFeed);
                    console.log("  TWAP duration:", config.deployFeedParams.duration);
                    // config.oracleParams.aggregator = AggregatorV3Interface(
                    ...
                    console.log("  Constant price:", config.deployFeedParams.constantPrice);
                    // config.oracleParams.aggregator = AggregatorV3Interface(
