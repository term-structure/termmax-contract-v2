...
// contract VaultWithPoolTestV2 is Test {
...
//         res.order =
//             TermMaxOrderV2(address(vault.createOrder(res.market, pool, orderConfigParams, orderConfig.curveCuts)));
