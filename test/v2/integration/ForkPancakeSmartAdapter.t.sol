...
contract ForkPancakeSmartAdapter is ForkBaseTestV2 {
    ...
    function _finishSetup() internal override {
        pancakeSmartAdapter = new PancakeSmartAdapter(pancakeSmartRouter);
    ...
    function testSwapExactIn() public {
        ...
        bytes memory swapData = abi.encode(data, isExactOut, inputAmount, netOutAmt, user);
        vm.startPrank(user);
    ...
    function testSwapExactOut() public {
        ...
        bytes memory swapData = abi.encode(data, isExactOut, exactOutputAmount, maxInputAmount, user);
    ...
    function testRevertWhenTradeAmountMismatch() public {
        ...
        bytes memory data =
            hex"";
        bool isExactOut = false;
        bytes memory swapData = abi.encode(data, isExactOut, wrongTradeAmount, netOutAmt, user);
    ...
    function testRevertWhenExactOutExceedsMaxInput() public {
        ...
        bytes memory swapData = abi.encode(data, isExactOut, maxInputAmount, netAmount, user);
    ...
    function testSwapWithDifferentRecipient() public {
        ...
        SwapPath[] memory swapPaths = new SwapPath[](1);
        swapPaths[0] =
            SwapPath({units: swapUnits, recipient: recipient, inputAmount: inputAmount, useBalanceOnchain: false});
