...
contract TermMax4626FactoryTest is Test {
    ...
    function setUp() public {
        ...
        defaultBufferConfig = StakingBuffer.BufferConfig({
            minimumBuffer: 1000e6,
            maximumBuffer: 10000e6,
            buffer: 5000e6
        });
    ...
    function testCreateStableERC4626For4626() public {
        ...
        StableERC4626For4626 vault = factory.createStableERC4626For4626(
            admin,
            address(thirdPool),
            defaultBufferConfig
        );
    ...
    function testCreateStableERC4626ForAave() public {
        ...
        StableERC4626ForAave vault = factory.createStableERC4626ForAave(
            admin,
            address(underlying),
            defaultBufferConfig
        );
    ...
    function testCreateVariableERC4626ForAave() public {
        ...
        VariableERC4626ForAave vault = factory.createVariableERC4626ForAave(
            admin,
            address(underlying),
            defaultBufferConfig
        );
    ...
    function testCreateMultipleVaultsWithSameParameters() public {
        // Create first vault
        StableERC4626For4626 vault1 = factory.createStableERC4626For4626(
            admin,
            address(thirdPool),
            defaultBufferConfig
        );
        ...
        StableERC4626For4626 vault2 = factory.createStableERC4626For4626(
            admin,
            address(thirdPool),
            defaultBufferConfig
        );
    ...
    function testCreateVaultsWithDifferentBufferConfigs() public {
        StakingBuffer.BufferConfig memory config1 = StakingBuffer.BufferConfig({
            minimumBuffer: 500e6,
            maximumBuffer: 5000e6,
            buffer: 2500e6
        });
        
        StakingBuffer.BufferConfig memory config2 = StakingBuffer.BufferConfig({
    ...
    function testCreateWithZeroAddressAdmin() public {
        vm.expectRevert();
        factory.createStableERC4626For4626(
            address(0),
            address(thirdPool),
            defaultBufferConfig
        );
    ...
    function testCreateStableERC4626ForAaveWithZeroUnderlying() public {
        vm.expectRevert();
        factory.createStableERC4626ForAave(
            admin,
            address(0),
            defaultBufferConfig
        );
    ...
    function testCreateVariableERC4626ForAaveWithZeroUnderlying() public {
        vm.expectRevert();
        factory.createVariableERC4626ForAave(
            admin,
            address(0),
            defaultBufferConfig
        );
    ...
    function testCreateWithInvalidBufferConfig() public {
        ...
        StakingBuffer.BufferConfig memory invalidConfig = StakingBuffer.BufferConfig({
            minimumBuffer: 10000e6,
            maximumBuffer: 5000e6,
            buffer: 7500e6
        });
        ...
        invalidConfig = StakingBuffer.BufferConfig({
            minimumBuffer: 5000e6,
            maximumBuffer: 10000e6,
            buffer: 4000e6
        });
    ...
    function testEventEmissions() public {
        ...
        vm.expectEmit(true, false, false, false);
        emit StableERC4626ForAaveCreated(address(this), address(0));
        StableERC4626ForAave vault2 = factory.createStableERC4626ForAave(admin, address(underlying), defaultBufferConfig);
        
        // Test VariableERC4626ForAaveCreated event
        vm.expectEmit(true, false, false, false);
        emit VariableERC4626ForAaveCreated(address(this), address(0));
        VariableERC4626ForAave vault3 = factory.createVariableERC4626ForAave(admin, address(underlying), defaultBufferConfig);
    ...
    function testVaultFunctionality() public {
        ...
        StableERC4626For4626 stableVault = factory.createStableERC4626For4626(admin, address(thirdPool), defaultBufferConfig);
    ...
    function testCreateVaultWithExtremeTotalSupply() public {
        ...
        aavePool.setReserveData(
            address(extremeToken),
            address(extremeAToken),
            address(stableDebtToken),
            address(variableDebtToken)
        );
        
        // Create appropriate buffer config for 18 decimal token
        StakingBuffer.BufferConfig memory extremeBufferConfig = StakingBuffer.BufferConfig({
            minimumBuffer: 1000e18,
            maximumBuffer: 10000e18,
            buffer: 5000e18
        });
        
        // Should still be able to create vaults
        StableERC4626For4626 vault1 = factory.createStableERC4626For4626(admin, address(extremePool), extremeBufferConfig);
        StableERC4626ForAave vault2 = factory.createStableERC4626ForAave(admin, address(extremeToken), extremeBufferConfig);
