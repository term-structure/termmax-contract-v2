...
contract VariableERC4626ForAaveInvariantTest is StdInvariant, Test {
    ...
    function invariant_totalAssetsGeSupply() public view {
        ...
        assertTrue(
            totalAssets >= totalSupply || totalSupply == 0, "Total assets should be >= total supply for variable vault"
        );
    }
    ...
    function invariant_sharePriceMonotonic() public {
        ...
        assertTrue(currentSharePrice >= lastSharePrice, "Share price should be monotonic (non-decreasing)");
    ...
    function invariant_yieldIncreasesTotalAssets() public view {
        ...
        if (totalSupply > 0 && totalYield > 0) {
            ...
            assertTrue(totalAssets >= totalSupply, "Total assets should reflect yield accumulation");
        }
    }
    ...
    function invariant_exchangeRateProtection() public {
        ...
        assertTrue(currentExchangeRate >= minimumAllowedRate, "Exchange rate should not decrease significantly");
