...
contract ForkPriceFeed is ForkBaseTest {
    ...
    function testPriceFeed() public {
        ...
        address pufferEthOracle;
        {
            ...
            AggregatorV3Interface pufferEthFeed = AggregatorV3Interface(
                priceFeedFactory.createPriceFeedConverter(pufferEthToEth, ethToUsd)
            );
...

        {
            ...
            AggregatorV3Interface usdcPlusFeed = AggregatorV3Interface(
                priceFeedFactory.createPriceFeedWithERC4626(usdcToUsd, USUALUSDCPlusVault)
            );
...

        {
            ...
            AggregatorV3Interface wethFeed = AggregatorV3Interface(
                priceFeedFactory.createPriceFeedWithERC4626(wethToUsd, MCwETHVault)
            );
...

        {
            ...
            AggregatorV3Interface ptFeed = AggregatorV3Interface(
                priceFeedFactory.createPTWithPriceFeed(pendlePYLpOracle, PT_pufETH_26JUN2025_market, 900, pufferEthOracle)
            );
            (, int256 answer, , , ) = ptFeed.latestRoundData();
...

        {
            ...
            AggregatorV3Interface usdeFeed = AggregatorV3Interface(
                priceFeedFactory.createPriceFeedWithERC4626(usdeToUsd, eUSDeVault)
            );
...

        {
            ...
            AggregatorV3Interface usd0PlusPlusFeed = AggregatorV3Interface(
                priceFeedFactory.createPTWithPriceFeed(pendlePYLpOracle, PT_USD0PlusPlus_26JUN2025_market, 900, usd0PlusPlusToUsd)
            );
...

        {
            ...
            address usdcToUsd = 0x8fFfFfd4AfB6115b954Bd326cbe7B4BA576818f6;
            AggregatorV3Interface usdcFeed = AggregatorV3Interface(
                priceFeedFactory.createPriceFeedWithERC4626(usdcToUsd, upUSDCVault)
            );
...

        {
            ...
            AggregatorV3Interface usualFeed = AggregatorV3Interface(
                priceFeedFactory.createPriceFeedWithERC4626(usualToUsd, usualxVault)
            );
